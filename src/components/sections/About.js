  ...
  return (
    <Section id="about">
      <Container>
        ...
        <Box>
          <Title>
          Welcome To The <br/> Tadpoles Club.
          </Title>
          <SubText>
          The TADPOLES CLUB is a private collection of NFTs—unique digital collectibles. The Tadpoles are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS.
          </SubText>
          <SubTextLight>
